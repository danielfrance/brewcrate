...
var Admin = {
	...
	init : function(){
		...
		// Deletes
		$('a.delete,button.delete,input.delete').on('click',function()
		{
	...
	{
		var page_content_id = $('.page-content').attr('data-id');

		$.ajax({
			url: '/admin/pages/add-component',
			type: 'post',
			data: { "page_content_id": page_content_id, "component": component  },
