	...
	<header class="blue_bg">
		<div class='max_wrapper'>
			...
			<div class="menu">
				...
				<div class='item'>
					<a class="text_white" href="/upcoming-crate">Upcoming Crate</a>
				</div>
				<div class='item'>
	...
	<div class="ui grid stackable">
		<div class="ten wide column">
				<div class="page_wrapper">
					...
					<h3 class='text_brown'>Upcoming Crate</h3>
					<p class="text_brown">Your next minute will be delivered around <span class='text_red'>Dec. 24th 2014</span></p>
