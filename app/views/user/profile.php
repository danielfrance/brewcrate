	...
	<header class="blue_bg">
		<div class='max_wrapper'>
			...
			<div class="menu">
				...
				<div class='item'>
					<a class="text_white" href="/profile">Profile</a>
				</div>
				<div class='item'>
		...
		<div class="ui grid stackable">
			<div class="ten wide column">
				<?php
				  ...
				  ?>
				<h3 class="text_brown">Profile Info</h3>
				<form class="ui form" method='post' action="update_profile">
					<input type='text' name="first_name" placeholder='<? echo"{$user['first_name']}"?>'><br><br>
					<input type='text' name="last_name" placeholder='<? echo"{$user['last_name']}"?>'><br><br>
					<input type='text' name="email" placeholder='<? echo"{$user['email']}"?>'><br><br>
					<input type='password' name="password" placeholder='New Password'><br><br>
					<input type='password' name="password_confirm" placeholder='Confirm New Password'><br><br>
